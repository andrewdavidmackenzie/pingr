                                ...
                                connection_device_statuses.iter().map(|(connection, device_status_list)| {
                                    ...
                                    view! {
                                        <li>
                                            {connection}
                                            {
                                                device_status_list.iter().map(|(device_id, status, name)| {
